...
const EXT: Cfg = { src: wallFacade, aspect: 1376 / 768, cover: true, bg: "#cdc8c1", door: { bottom: 10, height: 68 } };
const INT: Cfg = { src: wallFacadeInt, aspect: 1376 / 768, cover: true, bg: "#d8d4ce", door: { bottom: 9, height: 68 } };
